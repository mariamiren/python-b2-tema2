...
@pytest.fixture
def housing_data():
    current_dir = Path(__file).parent
...
def perform_linear_regression(
    ...
    assert r_value**2 <= 1, "The r squared value should be lles tan or equal to 1"
...
def plot_regression_line(housing_data)
    slope: 8  #Use fictitious values for the clope and the intercept
    intercept: -1
    ...
    assert ax.get_ylaberl() == "MEDV", "The Y axis label is not correct"
