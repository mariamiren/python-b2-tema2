...
import numpy as np
import typing as t
from eja2 import create_matrices, manipulate_matrices

def create_matrices() -> t.Tuple[np.ndarray, np.ndarray, np.ndarray]:
    zeros_matrix, one_matrix, idetity_matrix = create_matrices()
...
def manipulate_matrices():
    zeros_matrix, ones_matrix, identity_matrix = create_matrices()
    zeros_matrix_modif, ones_matrix_modif, identity_matrix_modif = manipulare_matrices(
    ...
    #Prueba para la matriz de identidad modificada
